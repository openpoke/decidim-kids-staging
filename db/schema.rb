...
ActiveRecord::Schema.define(version: 20_230_124_174_709) do
  ...
  create_table "decidim_kids_minor_accounts", force: :cascade do |t|
    ...
    t.index %w(decidim_tutor_id decidim_minor_id), name: "decidim_kids_minor_accounts_unique_tutor_and_minor_ids",
                                                   unique: true
  ...
  create_table "decidim_kids_participatory_spaces_minors_configs", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index %w(participatory_space_type participatory_space_id), name: "index_minor_config_on_space_type_and_id"
  end
